namespace TombIDE
{
	partial class FormProjectSetup
	{
		...
		private void InitializeComponent()
		{
			...
			comboBox_EngineType.Items.AddRange(new object[] { "- Select -", "Tomb Raider 1 (TR1X)", "Tomb Raider 2 (TR2X)", "Tomb Raider 2 (TR2Main)", "Tomb Raider 3 (TR3X)", "Tomb Raider 3 (tomb3)", "Tomb Raider 4 (Original TRLE)", "Tomb Raider Next Generation", "Tomb Raider Next Generation - Community Edition", "Tomb Engine" });
